...
func main() {
	...
	a.SetString("1000000000123455129991000000", 10) // Замените "1000000" на значение переменной a
	b.SetString("9999999993214419", 10)             // Замените "2000000" на значение переменной b
