...
// Проблема в данном фрагменте кода связана с созданием среза justString из большой строки v.
...
// Теперь мы не ссылаемся на оригинальный массив данных v, и лишние данные будут корректно освобождены.
